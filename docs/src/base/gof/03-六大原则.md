...
class AbstractSkin{
 ...
 AbstractSkin <|-- DefaultSpecificSkin:Inheritance
 AbstractSkin <|-- HeimaSpecificSkin:Inheritance
 AbstractSkin <.. SouGouInput : Dependency
```
...
Square  -->  Rectangle :继承
RectangleDemo  ..>  Rectangle : «create»
```
...
Rectangle  ..|>  Quadrilateral:实现
Square  ..|>  Quadrilateral :实现
RectangleDemo  ..>  Rectangle : «create»
RectangleDemo  ..>  Square : «create»
```
...
Computer "1" *--> "cpu 1" IntelCpu 
Computer "1" *--> "memory 1" KingstonMemory 
Computer "1" *--> "hardDisk 1" XiJieHardDisk 
```
