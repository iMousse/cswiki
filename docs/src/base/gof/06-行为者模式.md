...
Client  ..>  Order : «create»
Client  ..>  SeniorChef : «create»
Client  ..>  Waitor : «create»
Client  ..>  OrderCommand : «create»
OrderCommand  ..>  Command 
OrderCommand "1" *--> "order 1" Order 
OrderCommand "1" *--> "receiver 1" SeniorChef 
Waitor "1" *--> "commands *" Command 
...
![image-20200214110924010](assets/image-20200214110924010.png)
...
class GameRole {
  ...
  + void recoverState(RoleStateMemento state)
}
...
public class GameRole {
    ...
    //保存角色状态 声明类为Memento，返回类为RoleStateMemento
...
![](assets/image-20200215225227616.png)
