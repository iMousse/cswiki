...
- 对业务进行调研，对接口文档进行编写，并设计相关功能模块。

- 负责公司产品的研发或二次开发定制等研发活动，并按照计划完成工作。

  

负责与客户进行深入交流，精准把握并转化需求，确保设计方案满足业务目标并高效实施。
...
主导公司数据仓库产品的研发及定制化开发工作，确保项目按时高质完成。

持续跟踪最新数据仓库技术动态，推动技术创新和产品升级，增强公司在行业内的竞争力。负责公司产品的研发或二次开发定制等研发活动，并按照计划完成工作
...
我从开科入职已三年有余，在这期间做了贵州理财和代销系统，天府银行商业养老保险，现在在吉林银行做财富7.1平台。

在贵州银行理财系统期间，由于数据量大增加导致确认份额的数据过大，生产上确认导入批量跑不过去，我将自己写的方案交给领导审查，通过后交给行方执行，成功的解决了生产问题，后续将确认导入批量进行优化，将批量任务缩短了3倍。在订单期间，都会先写好详细的设计文档，和领导进行订单和功能评审，评审通过后才会将订单交给行方。做完订单后会将代码进行评审，上线前对代码进行检查，保证了代码的质量和项目的安全性。在理财子期间前期实现了代码版本的兼容问题，然后对理财子的跑批模块进行了实现，对理财登协议进行了实现，并且对需求上的一些功能进行同步的编写，在这期间深入理解了理财子的业务，对个人业务和技术都进行了提升。在贵州银行期间，个人编写的功能在行内都平稳运行，没有生产问题。对行内科技和业务人员的客户关系也维护的比较好。

在天府银行期间主要是对商业养老保险的前端进行编写，由于本人主要是后端工作，但在接到任务后并没有退缩，而是第一时间就对 H5 进行了学习。在入场期间，由于行方对前端页面修改的工作量比较多，我会因为工作计划跟不上在平时和周末自觉加班，在行方要求的时间内按时完成任务，行方科技和项目组上的成员都对我评价较高。
