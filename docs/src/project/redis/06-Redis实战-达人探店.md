...
![1653578992639](https://mugrain.oss-cn-hangzhou.aliyuncs.com/cswiki/1653578992639.png)

文件上传的设置：

![image-169355136195424](https://mugrain.oss-cn-hangzhou.aliyuncs.com/cswiki/image-169355136195424.png)
...
![1653579931626](https://mugrain.oss-cn-hangzhou.aliyuncs.com/cswiki/1653579931626.png)
...
![1653581590453](https://mugrain.oss-cn-hangzhou.aliyuncs.com/cswiki/1653581590453.png)
...
![1653805077118](https://mugrain.oss-cn-hangzhou.aliyuncs.com/cswiki/1653805077118.png)
...
![1653805203758](https://mugrain.oss-cn-hangzhou.aliyuncs.com/cswiki/1653805203758.png)

<br/>

**修改代码**：

点赞逻辑代码：BlogServiceImpl
...
public Result likeBlog(Long id) {
    ...
    if (score == null) {
        ...
        if (isSuccess) {
            stringRedisTemplate.opsForZSet().add(key, userId.toString(), LocalDateTime.now().toEpochSecond(ZoneOffset.UTC));
        }
    } else {
        //4.如果已点赞，取消点赞
        //4.1 数据库点赞数 -1
