...
![ksc.gif](assets/1663557792268-e080928e-cf37-48c0-9daf-16a13f246d83.gif)

## 需求分析

快递员在登录到APP后，可以查看取派件任务列表：
![image.png](assets/1663558501646-3c4639dd-979a-4fe7-a4e3-0298270a84d6.png)

![image.png](assets/1663558531383-ec8cb43c-27d5-49bf-9a9f-4b3907d87862.png)
...
![](assets/05e510db1b8bfec60315673e3ce3cf66.svg)快递员取消取件任务的原因为【因个人无法取件，退回到网点】时，需要重新生成取件任务：
![](assets/1bdad878d1b8d78fd06e1bcbb24fcfe0.svg)#### 派件任务流程
派件任务会在两个场景下生成：
...
场景一：
![](assets/c39b07cff3f5d227bfb8f7b4bc551661.svg)场景二：
![](assets/44047a7e6c8d755c140d918dc238e6fc.svg)## 取派件任务
...
快递员取消时选择的原因：
![image.png](assets/1663646725786-21517f84-97e8-4fd5-bc73-e81bd0a3d604.png)
...
基于swagger的测试：
![image.png](assets/1663660368072-d14a58f0-c2eb-4f7f-8667-a6d11b4cd47e.png)

![image.png](assets/1663660390465-5720da44-8664-4037-b754-c3e0915fbcee.png)
...
public class OrderMQListener {
     ...
     * 举例：
     * 现在10:30分，用户期望：11:00 ~ 12:00上门，实时发送
     * 现在10:30分，用户期望：13:00 ~ 14:00上门，延时发送，12点发送消息，延时1.5小时发送
     *
     * @param msg 消息内容
     */
...
启动之后，可以查看快递员的排班情况：
![image.png](assets/1673675994614-81c99020-6c5d-4996-90c6-1937fd4b682a.png)

快递员有所属的机构：
![image.png](assets/1673494349533-7a607dd1-3a33-4e03-a1c5-077ebff8e6b6.png)
...
查询到快递员：
![image.png](assets/1663725260325-ddf105bf-8786-4949-a0c8-000919ad60a1.png)

延时发送：
![image.png](assets/1663725460304-6f0829ef-da86-4f95-b953-ad872151cbd1.png)

![image.png](assets/1663725518811-4830af91-2493-4b87-a7f3-527a443d5da8.png)

wok中接收到调度中心发来的消息：
![image.png](assets/1663727667464-006cd3fc-3fa5-4194-9dfc-efc6f16818f0.png)
...
测试结果：
![image.png](assets/1663746574057-6d42329f-1f05-4259-b1d6-cb0c0f723e50.png)
