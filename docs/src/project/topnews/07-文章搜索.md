...
![image-20240310155254209](assets/image-20240310155254209.png)

今日内容

![image-20240213120336049](assets/image-20240213120336049.png)
...
![image-20240310155526951](assets/image-20240310155526951.png)
...
![image-20240310155537679](assets/image-20240310155537679.png)



### 创建索引和映射

![image-20240111195052815](assets/image-20240111195052815.png)

使用postman添加映射

put请求 ： http://47.108.90.242:9200/app_info_article
...
GET请求查询映射：http://47.108.90.242:9200/app_info_article

DELETE请求，删除索引及映射：http://47.108.90.242:9200/app_info_article

GET请求，查询所有文档：http://47.108.90.242:9200/app_info_article/_search
...
![image-20210709142215818](assets\image-20210709142215818.png)
...
postman查询所有的es中数据   GET请求： http://47.108.90.242:9200/app_info_article/_search

![image-20210709142339535](assets\image-20210709142339535.png)
...
![image-20210709142616797](assets\image-20210709142616797.png)
...
![image-20240310155650430](assets/image-20240310155650430.png)
...
![image-20240310155803927](assets/image-20240310155803927.png)
...
![image-20240310155821463](assets/image-20240310155821463.png)
...
![image-20240310155841913](assets/image-20240310155841913.png)

用户输入关键字进行搜索的异步记录关键字

![image-20240310155853615](assets/image-20240310155853615.png)
...
![image-20210709160036983](assets\image-20210709160036983.png)
...
![image-20240310160006694](assets/image-20240310160006694.png)
